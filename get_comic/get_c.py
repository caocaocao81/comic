...
for comic in comic_list:
    ...
    #以漫画名字为文件夹名创建文件夹
    if not os.path.exists('comic/' + str(name_comic)):
    ...
    for item in item_list:
        ...
        #print(page_name)
        #再以章节名命名一个文件夹
        if not os.path.exists('comic/' + str(name_comic) + '/' + str(page_name)):
        ...
        print(1)
        #webdriver位置
        path = "D:\\python_projects\\flask\\get_comic\\chromedriver.exe"
        #浏览器参数设置
