(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header><img src='"+obj.img+"' style='font-size: 24px;'></header><div class='comment-right'><h3>"+obj.replyName+"</h3>"
				+"<div class='comment-content-header'><span><i class='fa fa-clock-o'></i>"+obj.time+"</span>";
